                            ...
                            child: Container(
                              ...
                              child: RoundedButton(
                                icon: SizedBox(
                                  height: 20,
                                  child: Image.asset(
                                      'packages/web3plugin_setheum/assets/images/assets_send.png'),
                                ),
                                text: dic['transfer'],
                                color: colorOut,
                                onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      leading: SvgPicture.asset(
          'packages/web3plugin_setheum/assets/images/${data.isSuccess ? isOut ? 'assets_up' : 'assets_down' : 'tx_failed'}.svg',
          width: 32),
